...
import { ServiciosComponent } from './componentes/servicios/servicios.component'; // Importamos el componente Servicios
...
const routes: Routes = [
  ...
  { path: "servicios", component: ServiciosComponent }, // Agregamos la ruta para Servicios
];
